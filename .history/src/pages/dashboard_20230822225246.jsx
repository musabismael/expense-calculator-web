...
function DashboardPage() {
  ...
  const expenses = [
    { id: 1, description: 'Groceries', amount: 50, category: 'Food', date: '2023-08-10' },
    { id: 2, description: 'Transportation', amount: 30, category: 'Transport', date: '2023-08-15' },
    { id: 3, description: 'Entertainment', amount: 20, category: 'Entertainment', date: '2023-08-20' },
