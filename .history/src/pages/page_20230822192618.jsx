    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="bg-white shadow-md rounded-lg px-8 py-10 w-1/3">
        <div className="flex justify-center items-center mb-6">
          <img src="/images/logo.png" alt="Logo" className="logo-animation h-16 w-16 mr-2" />
          <h1 className="text-2xl font-bold">Expense Calculator</h1>
        </div>
        <h2 className="text-2xl font-bold mb-6 text-center">Welcome to the Expense Calculator</h2>
        ...
        <div className="space-y-4">
          ...
          <Link href="/register">
            <a href="/register" className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Register</a>
          </Link>
        </div>
